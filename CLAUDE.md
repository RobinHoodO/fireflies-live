...
Failure pings Telegram via `OnFailure=os-ping-fail@%n`. Meeting records
...
This project is indexed by GitNexus as **fireflies-live** (532 symbols, 1443 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/fireflies-live/process/{processName}` — trace the full execution flow step by step
